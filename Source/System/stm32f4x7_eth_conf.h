...
#define PHY_SR    ((uint16_t)0x1F) /* Value for PHY1 status register*/

#define PHY_SPEED_DUPLEX_STATUS  ((uint16_t)0x0007)
...
#define PHY_SPEED_STATUS            ((uint16_t)0x0008) /* Value for KSZ8041 PHY */
#define PHY_DUPLEX_STATUS           ((uint16_t)0x0010) /* Value for KSZ8041 PHY */
